...
public class GenerateData implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user2 = new User("parkingboy1", "梁非凡", "bd72696", "120@qq.com", "13160675789");
		user2.setRoles(Arrays.asList(parkingBoy));
		user2.setWorkStatus(STATUS_ONDUTY);
		user2.setLastSignInDate(ZonedDateTime.now());
		User user3 = new User("manager", "波澜哥", "bd72696", "130@qq.com", "13160675789");
		user3.setRoles(Arrays.asList(manager));
		user3.setWorkStatus(STATUS_ONDUTY);
		User user4 = new User("parkingboy2", "唐马儒", "bd72696", "121@qq.com", "13160675789");
		user4.setRoles(Arrays.asList(parkingBoy));
		user4.setWorkStatus(STATUS_ONDUTY);
		User user5 = new User("parkingboy3", "王境泽", "bd72696", "122@qq.com", "13160675789");
		user5.setRoles(Arrays.asList(parkingBoy));
		User user6 = new User("parkingboy4", "张全蛋", "bd72696", "123@qq.com", "13164675789");
		user6.setRoles(Arrays.asList(parkingBoy));
		User user7 = new User("parkingboy5", "李云龙", "bd72696", "124@qq.com", "13162434789");
		...
		User user9 = new User("parkingboy7", "面筋哥", "bd72696", "126@qq.com", "13160333789");
		user9.setRoles(Arrays.asList(parkingBoy));
		user9.setWorkStatus(STATUS_ONDUTY);
		User user10 = new User("parkingboy8", "韩红", "bd72696", "127@qq.com", "13112675789");
		...
		User user12 = new User("parkingboy10", "冯巩", "bd72696", "129@qq.com", "13160423489");
		user12.setRoles(Arrays.asList(parkingBoy));
		User user13 = new User("parkingboy11", "金馆长", "bd72696", "132@qq.com", "1311234789");
		...
		LotOrder order2 = new LotOrder("粤C7647", "2");
		...
		LotOrder order13 = new LotOrder("粤NH3747", "13");
